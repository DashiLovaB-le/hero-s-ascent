    ...
    >
      ...
      <Panel className="mt-4 border-destructive/30" title="Zona de risco">
        <p className="mb-3 text-sm text-white/55">
          ...
          sessões de exercício validado (flexões e métricas), metas (e vínculos com hábitos),
          check-ins, missões, notificações, scores ML e uso de IA. Zera XP, streak, capítulo e
          atributos (volta tudo para 1). Mantém conta, nome, hábitos cadastrados e roles.
        </p>
        <AlertDialog
          open={clearOpen}
          onOpenChange={(open) => {
